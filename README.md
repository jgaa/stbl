...
- [x] Generates static HTML5 / responsive websites that can be served by any http server. This includes scaling banner-images automatically for articles so that each device can download the optimal image based on screen size.
- [x] RSS feeds
